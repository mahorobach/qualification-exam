...
| 年度別内訳 | 2020:12問 / 2021:12問 / 2022:12問 / 2023:22問 / 2024:101問 / 2025:56問 |
| カテゴリ | 基礎科目、適性科目（法令・倫理）、専門科目（機械部門） |
| 年度別演習タイマー | 50分 |
| 全年度ランダムタイマー | 110分 |

2024年度は公式R06をベースにしたオリジナル問題を追加し101問に拡充済みです。2025年度は重複問題51問を削除後、公式R07をベースにしたオリジナル問題を追加し56問となっています。2020〜2023年度は初期問題セットのため、本試験1年度相当の問題量には達していません。ポータル上でも「5年分を完全収録」と誤認される表記は避けます。
